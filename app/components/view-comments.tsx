...
import { Divide, MessageCircle } from "lucide-react";
...
export const ViewComments = ({ comments, pathname, readonly}: ViewCommentsProps) => {
    return (
        <>
        {
            readonly ? (<div className="flex justify-center items-center group">
